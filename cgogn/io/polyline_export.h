...
class PolylineExport : public MeshExport<MAP>
{
public:
    using Inherit = MeshExport<MAP>;
    using Self = PolylineExport<MAP>;
    using Map = MAP;
    ...
    inline PolylineExport()
    {}

    virtual ~PolylineExport()
    {}
...
#endif // CGOGN_IO_POLYLINE_EXPORT_EXPORT_H_
