...
protected:
	...
	virtual bool import_file_impl(const std::string& filename) override
	{
		...
		for (uint32 i = 0; i < nb_vertices; ++i)
		{
			...
			(*position)[vertex_id] = { Scalar(Cx), Scalar(Cy), Scalar(Cz) };
...
extern template class CGOGN_IO_EXPORT SkelGraphImport<UndirectedGraph,Eigen::Vector3d>;
extern template class CGOGN_IO_EXPORT SkelGraphImport<UndirectedGraph,Eigen::Vector3f>;
extern template class CGOGN_IO_EXPORT SkelGraphImport<UndirectedGraph,geometry::Vec_T<std::array<float64,3>>>;
extern template class CGOGN_IO_EXPORT SkelGraphImport<UndirectedGraph,geometry::Vec_T<std::array<float32,3>>>;
